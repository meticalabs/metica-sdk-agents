...
// The API key contains a comma; a naive comma-split would mis-read the 3rd arg
// as "app" and PASS. The string-aware parser must still see the test user ID.
public class MeticaBootstrap : MonoBehaviour
{
    void Start()
    {
        ...
        MeticaSdk.Initialize(new MeticaInitConfig("ab,cd", "app", "test-user"), null, r => {});
